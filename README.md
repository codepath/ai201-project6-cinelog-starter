...
The app starts on `http://localhost:5000` and uses a local SQLite database (`cinelog.db`). `seed.py` loads a demo user and a few films so the endpoints have data to return.
